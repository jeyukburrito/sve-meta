      ...
      <section className="space-y-4">
        <article className="rounded-3xl border border-line bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-neutral-600">
            {user.email ?? "현재 로그인한 계정"} 정보와 누적 사용 현황을 확인합니다.
          </p>
          <Link
        ...
        <article className="rounded-3xl border border-line bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-neutral-600">추적할 카드게임 카테고리를 관리합니다.</p>
          <Link
            href="/settings/games"
            className="mt-4 inline-flex rounded-full border border-line px-4 py-2 text-sm font-medium"
          >
        ...
        <article className="rounded-3xl border border-line bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-neutral-600">카드게임별로 사용하는 덱을 정리합니다.</p>
          <Link
            href="/settings/decks"
            className="mt-4 inline-flex rounded-full border border-line px-4 py-2 text-sm font-medium"
          >
        ...
        <article className="rounded-3xl border border-line bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-neutral-600">필터를 고른 뒤 CSV 파일로 경기 기록을 내려받습니다.</p>
          <Link
        ...
        <article className="rounded-3xl border border-line bg-white p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm text-neutral-600">현재 계정 세션을 종료합니다.</p>
